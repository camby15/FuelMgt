...
class UpdateTeamMemberRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'employee_id' => 'required|string|max:255|unique:team_members,employee_id,' . $teamMemberId . ',id,company_id,' . $companyId,
            'position' => 'required|string|max:255',
            'department_id' => 'required|exists:department_categories,id',
            'phone' => 'required|string|max:20',
            'email' => 'required|email|max:255|unique:team_members,email,' . $teamMemberId . ',id,company_id,' . $companyId,
