    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/pages/hr-management.js',
    ...
    build: {
        ...
        rollupOptions: {
            ...
            output: {
                ...
                manualChunks: {
                    moment: ['moment'],
                    vendor: ['jquery', 'bootstrap', 'apexcharts'],
                },
            },
            plugins: [
                // Exclude all moment locales to reduce build size
                {
                    name: 'ignore-moment-locales',
                    resolveId(source) {
                        if (source.includes('moment/locale/')) {
                            return { id: source, external: true };
                        }
                        return null;
                    },
                    load(id) {
                        if (id.includes('moment/locale/')) {
